...
class PomodoroTimer:
    ...
    def __init__(self):
        ...
        self.root.title("Choppa Pomodoro Timer")
        self.root.tk.call('wm', 'iconphoto', self.root._w, PhotoImage(file="pomodoro.png"))

        self.s = ttk.Style()
        self.s.configure("TNotebook.Tab", font=("Times New Roman", 16))
        self.s.configure("TButton", font=("Times New Roman", 16))
        ...
        # TAB LABELS
        self.pomodoro_timer_label = ttk.Label(self.tab1, text="25:00", font=("Papyrus", 50))
        self.pomodoro_timer_label.pack(pady=20)

        self.short_break_timer_label = ttk.Label(self.tab2, text="5:00", font=("Papyrus", 50))
        self.short_break_timer_label.pack(pady=20)

        self.long_break_timer_label = ttk.Label(self.tab3, text="15:00", font=("Papyrus", 50))
        ...
        self.pomodoro_counter_label = ttk.Label(self.grid_layout, text="Pomodoros: 0", font=("Cursive", 20))
